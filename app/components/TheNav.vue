  ...
  <nav class="nav">
    <div class="container nav-inner">
      ...
      <ul class="nav-links hide-mobile">
        ...
        <li><NuxtLink to="/shop?type=others" class="nav-link">Others</NuxtLink></li>
      </ul>
    ...
    <div v-if="mobileOpen" class="mobile-menu fade-in">
      ...
      <NuxtLink to="/shop?type=fresh_flowers" @click="mobileOpen=false">Fresh Flowers</NuxtLink>
      ...
      <NuxtLink to="/shop?type=handmade_flowers" @click="mobileOpen=false">Handmade Flowers</NuxtLink>
      <NuxtLink to="/shop?type=others" @click="mobileOpen=false">Others</NuxtLink>
